...
class application(Frame):
    ...
    def create_widgets(self):
        self.lbl=Label(self,text="Null-score from .NUL file (GENPOP output file)")
    ...
    def przycisk1(self):
        ...
        self.okno3.insert(20.1,'Your Null-score file is ready. Check it under "'+self.output_name[0]+'.txt" name in the same folder.')
        self.output_name=[]
            
root=Tk()
root.title("App for Null score")
